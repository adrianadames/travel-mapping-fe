...
// export const address = process.env.NODE_ENV === 'development' ? 'http://localhost:4000' : 'https://piktorlogcopy.herokuapp.com';
export const address = 'https://piktorlogcopy.herokuapp.com';
